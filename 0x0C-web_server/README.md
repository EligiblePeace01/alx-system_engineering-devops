...
## What I Learned
I started utilizing a web server and learnt how they operate with this project. ALX gave me access to a personal server. I gained knowledge on how to move files to my server using Fabric and SCP. I also finished configuring the server using Nginx on a basic level.

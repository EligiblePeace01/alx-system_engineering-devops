...
This project served as further experience with APIs. Using the [JSONPlaceholder REST API](https://jsonplaceholder.typicode.com/), I gathered data and discovered how to export it in CSV or JSON formats.
